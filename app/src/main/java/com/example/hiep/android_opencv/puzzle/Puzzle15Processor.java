...
public class Puzzle15Processor {
    ...
    /* Với hàm xáo trộn vị trí các miếng ghép của trò chơi: shuffle(mIndexes)
     * và hàm check khả năng win của màn hình với miếng ghép đã bị xáo trộn: isPuzzleSolvable().
     * Nếu không có khả năng win, sẽ tiếp tục xáo trộn.
     */
    ...
    /* Cuối cùng, chúng ta sẽ chia ô cho game.
     * Ở đây sẽ chia màn hình ra thành các ô tương ứng mức độ chơi 4 * 4.
     * Và tô màu cho các viền kẻ giữa các ô, cũng như đánh số cho từng ô.
     */
